...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Dashboard  nopCommerce administration/a_Logout'), 'Logout')

WebUI.click(findTestObject('Object Repository/Page_Dashboard  nopCommerce administration/a_Logout'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Your store. Login/strong_Welcome, please sign in'), 'Welcome, please sign in!')
